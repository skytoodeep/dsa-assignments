...
has in the jth bank. Return the wealth that the richest customer has.A customer's wealth is the amount of money they
...
public class RichestCustomerWealth04 {
    public static void main(String[] args) {
        int[][] array = {{1,5},{7,3},{3,5}};
        System.out.println(maximumWealth(array));
    }

    private static int maximumWealth(int[][] array) {
        int sum;
        int max =0;
        for (int[] ints : array) {
            sum = 0;
